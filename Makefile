#############################################################################
# Makefile for building: toolcoin-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Sat May 14 19:11:22 2016
# Project:  TOOLCOIN-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake RELEASE=1 -o Makefile TOOLCOIN-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -Wl,-Bstatic -lminiupnpc /tmp/TOOLCOIN/src/leveldb/libleveldb.a /tmp/TOOLCOIN/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -Wl,-Bdynamic -lrt -ldl -lpthread -lQtGui -lQtCore 
AR            = ar cqs
RANLIB        = 
...
Makefile: TOOLCOIN-qt.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
	...
	$(QMAKE) RELEASE=1 -o Makefile TOOLCOIN-qt.pro
...
/tmp/TOOLCOIN/src/leveldb/libleveldb.a: FORCE
	cd /tmp/TOOLCOIN/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/tmp/TOOLCOIN/build/build.h: FORCE
	cd /tmp/TOOLCOIN; /bin/sh share/genbuild.sh /tmp/TOOLCOIN/build/build.h
